        ...
        <div className="hero-container">
            ...
            <div className="hero-content">
                <div className="left-content">
                    <h1>Conference Expense <br />Planner</h1>
                    <p>Plan your next major event with us!</p>
                    <Link to="/shop"><button className="cta-button">Get Started</button></Link>
                </div>
                <div className="right-content">
                    <p>
                        <strong>Welcome to Paradise Nursery, where green meets serenity!</strong>
                    </p>
                    <p>
                    ...
                    <p>
                        Join us in our mission to create a greener, healthier world. Visit Paradise Nursery today and experience the beauty of nature right at your doorstep.                    </p>
                </div>
            </div>
        </div>
    );
